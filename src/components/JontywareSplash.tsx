...
// works even if expo-splash-screen isn't installed. Typed loosely because the
// dynamic require() shape doesn't carry through TS — we only use hideAsync().
type SplashScreenModule = { hideAsync?: () => Promise<unknown> } | null;
let SplashScreen: SplashScreenModule = null;
try { SplashScreen = require("expo-splash-screen") as SplashScreenModule; } catch (e) {}
 ...
 */
export interface JontywareSplashProps {
  onFinish?: () => void;
  markSize?: number;
  fontFamily?: string;
  animateMark?: boolean;
